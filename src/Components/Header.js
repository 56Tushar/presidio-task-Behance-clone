      ...
      <header className="header" id="header">
        ...
        <div className="border-b fixed w-full top-0 bg-white z-10">
          <div className="contentHolder bg-white">
            <div className="top-header py-2 lgpy-3 px-5 border-b border bg-white">
              <div className="navbar top-0 left-0 bg-white w-full p-1 flex items-center justify-between z-99">
            ...
            <div className="search-area p-3 m-3">
              <div className="search-area flex items-center">
                <Search />
              </div>
            </div>
            <div className="hidden lg:block w-full">
              <div className="behance-tools pb-10 px-5 flex items-center justify-between w-full">
